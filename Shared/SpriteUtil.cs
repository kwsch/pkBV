...
namespace PKHeX.WinForms
{
    public static class SpriteUtil
    {
        ...
        public static Image GetBallSprite(int ball)
        {
            ...
            return (Image)Resources.ResourceManager.GetObject(str) ?? Resources._0; // Poké Ball (default)
        }
        ...
        private static Image GetBaseImage(MysteryGift gift)
        {
            if (gift.IsEgg && gift.Species == 490) // Manaphy Egg
                return (Image)(Resources.ResourceManager.GetObject("_0") ?? Resources.unknown);
            if (gift.IsPokémon)
        ...
        private static Image GetWallpaper(SaveFile SAV, int box)
        {
            ...
            return (Bitmap)(Resources.ResourceManager.GetObject(s) ?? Resources._0);
        }
        ...
        private static Image GetSprite(PKM pkm, SaveFile SAV, int box, int slot, bool flagIllegal = false)
        {
            ...
            if (flagIllegal)
            {
                ...
                if (!la.Valid && pkm.Species != 0)
                    sprite = ImageUtil.LayerImage(sprite, Resources._0, 0, 14);
            }
            if (inBox) // in box
            {
                if (SAV.IsSlotLocked(box, slot))
                    ...
                    sprite = ImageUtil.LayerImage(sprite, Resources._0, 21, 0);
            }
